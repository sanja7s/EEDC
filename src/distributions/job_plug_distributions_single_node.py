...
def read_in_data_per_node(the_node_type, the_variable):
	...
	single_job_nodes= ['c7', 'c6', 'c5', 'c4', 'c416', 'c417', 'c415',\
	 'c412', 'c333', 'c332', 'c331', 'c330', 'c336', 'c335', 'c334', \
	 'c636', 'c418', 'c419', 'c243', 'c246', 'c245', 'c836', 'c837', \
	 'c666', 'c658', 'c71', 'c70', 'c73', 'c72', 'c74', 'c474', 'c477', \
	 'c473', 'c433', 'c20', 'c835', 'c9', 'c8', 'c430', 'c431', 'c68', \
	 'c69', 'c66', 'c67', 'c432', 'c19', 'c18', 'c13', 'c12', 'c11', 'c10',\
	  'c16', 'c322', 'c323', 'c324', 'c326', 'c327', 'c328', 'c329', 'c423', \
	  'c422', 'c421', 'c420', 'c424']
	...
	with open(f_in, 'r') as f:
		for line in f:
			...
			if node not in single_job_nodes:
				continue
			i += 1
			if the_variable == 'avg plug':
				...
				if float(avg_var[node]) < 0.005:
					print node
	print 'processed %d nodes of type %s' % (i, the_node_type)
	return avg_var
...
def plot_data(plt, the_node_type='Haswell', the_variable='plug',s=17,col='coral'):
	...
	ylab = '# nodes'
	fname = the_node_type +'_distr_of_job_' +the_variable+ '.png'
